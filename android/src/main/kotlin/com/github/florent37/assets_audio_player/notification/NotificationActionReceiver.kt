    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            NotificationAction.ACTION_SELECT -> {
                ...
                val intent2: Intent = context.packageManager.getLaunchIntentForPackage(context.packageName)
                        ?: return
                intent2.setAction(NotificationAction.ACTION_SELECT)
                intent2.putExtra(NotificationService.TRACK_ID, trackID)
